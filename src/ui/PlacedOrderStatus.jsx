function PlacedOrderStatus({ order }) {
  ...
  return (
    <div className="text-slate-50 bg-secondary-600 rounded-xl w-max relative py-5 px-7 flex flex-col items-center min-w-[380px] md:mb-5 md:w-full md:min-w-full">
